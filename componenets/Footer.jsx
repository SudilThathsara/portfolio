    ...
    <div className='mt-20'>
        <div className='text-center'>
            ...
            <div className='w-max flex items-center gap-2 mx-auto'>
                ...
                sudilthathsara19@gmail.com
            </div>
        </div>

        <div className='text-center sm:flex items-center justify-between border-t border-gray-400 mx-[10%] mt-12 py-6'>
            <p>© 2024 Sudil Thathsara. All rights reserved.</p>
            <ul className='flex items-center gap-10 justify-center mt-4 sm:mt-0'>
                <li><a target='_blank' rel="noreferrer" href="https://github.com">GitHub</a></li>
                <li><a target='_blank' rel="noreferrer" href="https://linkedin.com">LinkedIn</a></li>
